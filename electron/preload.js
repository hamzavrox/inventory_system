...
contextBridge.exposeInMainWorld('api', {
  ...
  shopify: {
    ...
    importAll:        ()          => invoke('shopify:importAll'),
    getWebhookLogs:   (limit)     => invoke('shopify:getWebhookLogs', limit),
    clearWebhookLogs: ()          => invoke('shopify:clearWebhookLogs'),
    syncStatus:       ()          => invoke('shopify:syncStatus'),
  },

  webhooks: {
    start: (port) => invoke('webhooks:start', port),
    stop: () => invoke('webhooks:stop'),
    register: (webhookUrl) => invoke('webhooks:register', webhookUrl),
    test: (webhookUrl) => invoke('webhooks:test', webhookUrl),
